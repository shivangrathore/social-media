...
ALTER TABLE "attachment" ADD CONSTRAINT "attachment_post_id_user_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
